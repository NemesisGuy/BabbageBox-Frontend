...
const mockMemories = [
    { id: 1, content: 'First memory', conversation_id: 101, created_at: '2025-01-01T12:00:00Z' },
    { id: 2, content: 'Second memory regarding AI', conversation_id: 102, created_at: '2025-01-02T12:00:00Z' }
]
...
describe('MemoryManager', () => {
    ...
    it('deletes a memory', async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith('http://localhost:8000/api/memory/1', {
            method: 'DELETE'
        })
